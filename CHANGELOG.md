...
- `ProxyBasicAuth` middleware for static HTTP Basic proxy authentication on HTTP requests.
- `ProxyBasicAuthFunc` middleware for custom HTTP Basic proxy authentication validators.
